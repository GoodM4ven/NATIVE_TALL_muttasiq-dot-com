...
@php
    $baseButtonClasses =
        'app-action-button relative grid h-8 w-8 rotate-45 place-items-center overflow-hidden Xrounded-lg border-2 shadow transition-all outline-none rounded-md focus:ring-2 will-change-auto in-data-loading:opacity-0! sm:h-10 sm:w-10 md:h-10 md:w-10 lg:h-10 lg:w-10 sm:[zoom:0.9] md:[zoom:1] lg:[zoom:0.85] xl:[zoom:0.9] 2xl:[zoom:1.05] 3xl:[zoom:1.2] 4xl:[zoom:1.25]';
