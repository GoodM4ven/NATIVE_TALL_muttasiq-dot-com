<div
    ...
    x-data="{
        rippleStorageKey: 'athkar-reader-font-scale-ripple-dismissed-v1',
    ...
    x-transition
    x-cloak
    x-effect="if (views['athkar-app-gate']?.isReaderVisible) { hasReaderRenderedOnce = true }"
    x-on:athkar-reader-font-scale-overlay-visibility.window="if (Boolean($event.detail?.open)) { dismissRipplePermanently() }"
