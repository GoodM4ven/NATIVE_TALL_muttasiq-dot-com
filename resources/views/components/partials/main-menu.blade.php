<div
    class="3xl:[zoom:1.15] 4xl:[zoom:1.25] -top-40! sm:top-0! absolute inset-0 flex items-center justify-center [zoom:0.625] sm:[zoom:0.42] md:[zoom:0.55] lg:[zoom:0.75] xl:[zoom:0.8] 2xl:[zoom:1]"
    x-cloak
