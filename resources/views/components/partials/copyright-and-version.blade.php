...
>
    ...
    >
        <p
            class="leading-arabic inline-flex max-w-full items-center justify-center gap-1 overflow-hidden whitespace-nowrap text-center [text-wrap:nowrap]">
