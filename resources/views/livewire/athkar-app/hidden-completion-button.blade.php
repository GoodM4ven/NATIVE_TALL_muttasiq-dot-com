<div
    ...
    <button
        ...
        type="button"
        aria-label="{{ app_arabic_text('إتمام جميع الأذكار') }}"
        ...
        x-on:mouseenter="$tippy(@js(app_arabic_text('إتمام كل الأذكار')), 'bottom')"
        x-on:mouseleave="$tippy.hide()"
        x-on:focus="$tippy(@js(app_arabic_text('إتمام كل الأذكار')), 'bottom')"
