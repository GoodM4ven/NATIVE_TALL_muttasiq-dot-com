...
// it('executes hidden completion buttons on mobile for single thikr and all athkar', function () {
//     $page = visitMobile('/');
...
//     $hintToggleSelector = '[data-athkar-slide][data-active="true"] button[aria-label="العدد"]';
//     waitForScript(
//         $page,
//         js_template('Boolean(document.querySelector({{selector}}))', ['selector' => $hintToggleSelector]),
//         true,
//     );
//     scriptClick($page, $hintToggleSelector);
//     if (! $page->script(athkarReaderDataScript('data.isHintOpen('.$multiIndex.')'))) {
//         $page->script(athkarReaderCommandScript("data.toggleHint({$multiIndex});"));
//     }
//     waitForScript($page, athkarReaderDataScript('data.isHintOpen('.$multiIndex.')'), true);

//     $mobileCompleteSelector = '.sm\\:hidden [data-athkar-slide][data-active="true"] button[aria-label="إتمام الذكر"]';
//     waitForScript(
//         $page,
//         js_template('Boolean(document.querySelector({{selector}}))', ['selector' => $mobileCompleteSelector]),
//         true,
//     );
//     scriptClick($page, $mobileCompleteSelector);
