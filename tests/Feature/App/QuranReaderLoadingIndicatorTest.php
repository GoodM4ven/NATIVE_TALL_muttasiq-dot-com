...
it('renders teleported css jelly triangle loader indicator for quran calibration overlay', function () {
    ...
    expect($readerViewSource)->not->toBeFalse()
        ...
        ->and($readerViewSource)->toContain('class="quran-calibration-jelly-svg"')
        ->and($readerViewSource)->toContain('class="quran-calibration-jelly-group"')
        ...
        ->and($readerViewSource)->not->toContain('<l-jelly-triangle')
