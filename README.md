...
#### تفاصيل وضع الوِرد (قارئ القرآن)
- يوجد زر تقدّم خاص بالوِرد داخل شريط أدوات قارئ القرآن (بين السجلّ والعلامات المرجعية)، ويعمل كمفتاح تفعيل/إيقاف للوضع.
- عند التفعيل: يُقيَّد التنقّل على صفحات الوِرد المطلوبة لليوم فقط، مع استمرار دعم الأسهم، والسحب، وأزرار التنقّل.
- عند إتمام صفحات اليوم (بالتقدّم من آخر صفحة مطلوبة) يخرج الوضع تلقائيًا إلى القراءة الحرة.
- تقدّم الوِرد اليومي يُحفَظ محليًا (Persistent Storage / Local Storage) بشكل منفصل عن آخر صفحة قراءة حرة.
- إعدادات الوِرد متاحة من لوحة التحكم: وتيرة الهدف (`شهري` أو `يومي`) وعدد الختمات (حتى 4).
