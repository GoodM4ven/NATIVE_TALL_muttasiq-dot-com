...
- اعتماد تغييرات الإعدادات بدون الحاجة إلى الضغط على زر الحفظ في الأسفل
...
- **إضافة زر لاستعراض مقطع يشرح خصائص المنصة الحالية بالكامل**
- إضافة توضيحات بصرية لطريقة عمل بعض الأزرار ذات النقرتين في الأجهزة اللوحيّة والجوال
- تصغير حجم التطبيق عند التحميل في المتجر، قليلا

### الأذكار

- تسهيل التحكم في تغيير حجم نص الخط في قارئ الأذكار

### الكتاب

- تعديل تأثير التغيير بين الصفحات افتراضيّا، أي عندما لا تكون التأثيرات البصرية تعمل

<img src="images/v-1-3-0/web/home-app-walkthrough.webp" alt="Home app walkthrough modal with introductory video" height="320"/>


## [v1.2.0](https://github.com/GoodM4ven/NATIVE_TALL_muttasiq-dot-com/pull/198)
